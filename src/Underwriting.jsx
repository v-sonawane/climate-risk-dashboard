      ...
      {activeTab === 'underwriting' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {loading ? (
            ...
            <div className="col-span-full text-gray-500 text-center py-10">No matching challenges.</div>
          ) : filteredChallenges.map((c,i) => (
            <div key={i} className="border rounded-lg p-4 shadow hover:shadow-lg transition">
              <h4 className="font-semibold mb-2">{c.challenge}</h4>
              <div className="flex items-center text-sm text-gray-600 space-x-2 mb-2">
                ...
                <span className="px-2 py-1 bg-red-100 text-red-800 rounded">{c.impact_level}</span>
              </div>
